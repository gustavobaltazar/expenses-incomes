...
export function NewExchangeModal({
  ...
  return (
    <>
      {isActive ? (
        <div className="flex items-center justify-center fixed w-screen h-screen backdrop-blur-sm">
            ...
            <div className="w-[535px] h-[528px] bg-modal_background flex flex-col gap-10 rounded-md">
              <div className="flex justify-between items-center">
                ...
                <div
                  ...
                  className="text-white text-2xl font-bold w-12 h-12 cursor-pointer"
                >
                  <svg
              ...
              <div className="flex justify-center items-center ">
                <form className="flex flex-col items-start p-0 gap-4" action="">
                  <input
                    className="flex flex-row items-start p-3 gap-2 w-[439px] rounded-md bg-input_background text-text_classic"
